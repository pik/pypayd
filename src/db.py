...
class PyPayDB(object):
    """Database interface using apsw (I got some mixed info regarding pysqlite threading support: there seems to be a flag to enable it (sqlite3 does support threading) but I saw more than a few error reports as well) - therefore switching to APSW seemed like the safer bet.
    """
